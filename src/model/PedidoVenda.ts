...
export class PedidoVenda {
    static atualizarPedido(pedidoAtualizado: PedidoVenda) {
        throw new Error("Method not implemented.");
    }
    nome: number | undefined;
    cpf: number | undefined;
    telefone: Date | undefined;
    static pedidoatualizado(pedidoAtualizado: PedidoVenda) {
        throw new Error("Method not implemented.");
    }
    static pedidoAtualizado(pedidoAtualizado: PedidoVenda) {
        throw new Error("Method not implemented.");
    ...
    static async atualizarCliente(cliente: Cliente): Promise<boolean> { 
        try {
            ...
            return false; // Retorna false indicando que nada foi alterado
        } catch (error) {
